Create table If Not Exists _2_2_1661_leet_code_activity
(
    machine_id    int,
    process_id    int,
...
Truncate table _2_2_1661_leet_code_activity;
insert into _2_2_1661_leet_code_activity (machine_id, process_id, activity_type, timestamp)
...
FROM _2_2_1661_leet_code_activity AS start
         JOIN _2_2_1661_leet_code_activity AS end
