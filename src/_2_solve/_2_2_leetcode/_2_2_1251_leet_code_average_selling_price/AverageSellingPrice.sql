Create table If Not Exists _2_2_1251_leet_code_prices
(
    product_id int,
    start_date date,
    end_date   date,
...
Create table If Not Exists _2_2_1251_leet_code_units_sold
(
    product_id    int,
    purchase_date date,
    units         int
);
Truncate table _2_2_1251_leet_code_prices;
insert into _2_2_1251_leet_code_prices (product_id, start_date, end_date, price)
...
Truncate table _2_2_1251_leet_code_units_sold;
insert into _2_2_1251_leet_code_units_sold (product_id, purchase_date, units)
...
SELECT PRICES.product_id,
       COALESCE(
               ROUND(
                   ...
                   , 2)
           , 0) AS average_price
FROM _2_2_1251_leet_code_prices PRICES
         LEFT JOIN _2_2_1251_leet_code_units_sold UNITS_SOLD
